 ...
 */
package com.bwie.servicemodule.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.bwie.servicemodule.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.bwie.servicemodule.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
